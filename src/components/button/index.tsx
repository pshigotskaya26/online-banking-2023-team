...
const Button: React.FC<ButtonProps> = ({text, isDisable, isLoading = false, handleButton}) => {
  return <button
    className={`bg-blue-700 border text-white text-center primary-color inline-flex items-center px-5 py-2.5 ` +
      " text-sm font-medium text-center bg-primary-700 rounded-lg " +
