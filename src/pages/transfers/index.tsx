...
const TransfersPage = () => {
  ...
  const [isVisibleCalculator, setIsVisibleCalculator] =
    ...
    <ClientLayout>
      ...
      <div className="bg-white py-6 sm:py-8 lg:py-12">
        <div className={'flex justify-evenly mb-12'}>
          ...
          <div>
            <div className="w-96 h-56 m-auto bg-gray-100 rounded-xl relative shadow transition-transform transform hover:scale-105">
        ...
        <div className="flex justify-center align-middle items-center mb-4">
          ...
          <div className="relative justify-center content-center items-center">
            ...
            {isVisibleCalculator && (
              <div className={'border bg-gray-100 p-2 absolute min-w-[320px]'}>
