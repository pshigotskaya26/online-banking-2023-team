...
const AdminLayout: React.FC<ClientLayoutProps> = ({children}) => {
  return (
    <div>
        ...
        <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <button className="flex items-center">
              ...
              <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">nline-bank</span>
            </button>
            ...
            <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                ...
                <li>
                  <button
                    className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Team
                  </button>
                </li>
                <li>
                  <button
      ...
      <footer className="p-4 border-t-2 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
        <div className="mx-auto max-w-screen-xl text-center">
          <button className="flex justify-center items-center text-2xl font-semibold text-gray-900 dark:text-white">
          ...
          <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
            ...
            <li>
              <button className="mr-4 hover:underline md:mr-6">Premium</button>
            </li>
            <li>
              <button className="mr-4 hover:underline md:mr-6 ">Campaigns</button>
            </li>
            <li>
              <button className="mr-4 hover:underline md:mr-6">Blog</button>
            </li>
            <li>
              <button className="mr-4 hover:underline md:mr-6">Affiliate Program</button>
            </li>
            <li>
              <button className="mr-4 hover:underline md:mr-6">FAQs</button>
            </li>
            <li>
              <button className="mr-4 hover:underline md:mr-6">Contact</button>
            </li>
          </ul>
